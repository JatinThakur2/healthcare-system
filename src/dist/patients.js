...
export const createPatient = mutation({
    args: {
        ...
        complaints: v.optional(v.array(v.object({
            symptom: v.string(),
            severity: v.string(),
            duration: v.string(),
        }))),
        ...
        pastFamilyHistory: v.optional(v.array(v.object({
            condition: v.string(),
            details: v.string(),
        }))),
        anthropometricParameters: v.optional(v.object({
        ...
        clinicalParameters: v.optional(v.object({
            bloodPressure: v.optional(v.string()),
        ...
        laboratoryInvestigation: v.optional(v.object({
            ...
            additionalTests: v.optional(v.array(v.object({
                name: v.string(),
                value: v.string(),
        ...
        riskFactors: v.optional(v.object({
        ...
        treatmentPlan: v.optional(v.object({
        ...
        saqliQuestionnaire: v.optional(v.object({
